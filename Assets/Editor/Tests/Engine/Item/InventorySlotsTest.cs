...
public class InventorySlotsTest {
	...
	public void TestSetup() {
		_i1 = new Item (0, Item.ItemType.ARMOR, "armor", "it's armor", "armor", new AttributeCollection (), InventorySlots.SlotType.BODY, Item.ItemTier.TIER_5, "path/to/icon", "swordSFX", "swordVFX");
